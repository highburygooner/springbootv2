...
import net.haige.dwl.springboot.filter.JWTFilter;
import net.haige.dwl.springboot.filter.MyAccessFilter;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean factory(DefaultWebSecurityManager securityManager) {
       ...
       // filterRuleMap.put("/edit", "jwt, perms[edit]");
        ...
        filterRuleMap.put("/annotation/**", "jwt,myurl");
        filterRuleMap.put("/**", "anon");
        filterRuleMap.put("/edit", "jwt, roles[admin]");
